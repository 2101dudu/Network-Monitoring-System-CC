...
func handlePingTask(task parse.Task) {
	...
	ack.SendPacketAndWaitForAck(pingPacket.PacketID, utils.SERVERID, packetsWaitingAck, &pMutex, agentConn, nil, data, "[NetTask] Ping packet sent", "[ERROR 155] Unable to send ping packet")
}
